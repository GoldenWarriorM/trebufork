...
class RecentsViewUtils(private val recentsView: RecentsView<*, *>) : DesktopVisibilityListener {
    ...
    private fun getTaskMenu(): TaskMenuView? {
        // Cast through ActivityContext: RecentsView<*, *>'s mContainer platform type
        // degrades to Context! on Kotlin 2.x, but it is always a RecentsViewContainer.
        val container = recentsView.mContainer as ActivityContext
        return getTopOpenViewWithType(container, TYPE_TASK_MENU) as? TaskMenuView
    }
