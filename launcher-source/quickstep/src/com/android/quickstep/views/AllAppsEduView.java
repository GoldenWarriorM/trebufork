...
public class AllAppsEduView extends AbstractFloatingView {
    ...
    public static void show(Launcher launcher) {
        // trebufork: in scrollable home the workspace is hidden and there is no "swipe up to open
        // All Apps" gesture to educate about — don't show the swipe-up hint after repeated swipes.
        if (LauncherPrefs.SCROLLABLE_HOME.get(launcher)) {
            return;
        }
