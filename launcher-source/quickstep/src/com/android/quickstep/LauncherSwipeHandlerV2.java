    ...
    private HomeAnimationFactory createIconHomeAnimationFactory(
        ...
        return new FloatingViewHomeAnimationFactory(floatingIconView) {
            ...
            public RectF getWindowTargetRect() {
                // trebufork: return the live rect (shared with FloatingIconView's mPositionOut)
                // instead of a one-time snapshot, so the closing-window spring keeps re-targeting
                // to the icon as the scrollable home list scrolls (see FloatingIconView's scroll
                // listener + RectFSpringAnim.onTargetPositionChanged).
                return iconLocation;
            }
