...
public abstract class AbstractFloatingView extends LinearLayout implements TouchController,
    ...
    // trebufork: the scrollable-home top-inset adjustment overlay (drag the handle to change
    // the empty strip above the desktop/apps list, see ScrollableInsetAdjustView).
    public static final int TYPE_INSET_ADJUST = 1 << 26;
    ...
    public static final int TYPE_ALL = TYPE_FOLDER | TYPE_ACTION_POPUP
            ...
            | TYPE_NUDGE | TYPE_TASKBAR_OVERFLOW | TYPE_INSET_ADJUST;
