...
public class WorkspaceStateTransitionAnimation {
    ...
    private void setWorkspaceProperty(LauncherState state, PropertySetter propertySetter,
        ...
        // trebufork: in scrollable-home mode the hotseat is hidden by Launcher and must stay
        // hidden -- animating its alpha would re-show it (AlphaUpdateListener flips the view to
        // VISIBLE), leaking the dock/QSB through the transparent scrollable list.
